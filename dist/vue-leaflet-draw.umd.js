(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-leaflet-draw"] = factory();
	else
		root["vue-leaflet-draw"] = factory();
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/App.vue?vue&type=template&id=ea204b86&
...
/* harmony default export */ const Appvue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      _this.map = _this.refs || _this.$refs.map.mapObject;
    });
  },
  methods: {
    init: function init() {
    ...
    createEvents: function createEvents() {
      ...
      this.map.on('draw:created', function (e) {
        var layer = e.layer;
        _this3.editableLayers.addLayer(layer);
        _this3.$emit('created', layer);
      });
      this.map.on('draw:edited', function (e) {
        _this3.$emit('edited', e.layers);
      });
      this.map.on('draw:deleted', function (e) {
        _this3.$emit('deleted', e.layers);
      });
    },
    updateLabels: function updateLabels() {
      ...
      L.drawLocal.draw.toolbar.buttons.polygon = '<span class="mdi mdi-vector-polyline"></span>';
      L.drawLocal.draw.handlers.polygon.tooltip.start = 'برای شروع روی نقشه کلیک کنید';
      L.drawLocal.draw.handlers.polygon.tooltip.cont = 'نقطه بعدی را انتخاب کنید';
      L.drawLocal.draw.handlers.polygon.tooltip.end = 'با کلیک روی نقطه ابتدایی، شکل شما نهایی می‌شود';
      ...
      L.drawLocal.edit.toolbar.buttons.removeDisabled = 'شکلی برای حذف وجود ندارد';
      L.drawLocal.edit.handlers.edit.tooltip.text = 'مربع‌های اضلاع را برای ویرایش حرکت دهید';
      L.drawLocal.edit.handlers.edit.tooltip.subtext = 'انصراف از ویرایش';
      L.drawLocal.edit.handlers.remove.tooltip.text = 'روی شکلی که قصد حذف آن را دارید کلیک کنید';
    }
  }
});
...
//# sourceMappingURL=vue-leaflet-draw.umd.js.map